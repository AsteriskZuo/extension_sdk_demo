...
#define EXT_SDK_NAMESPACE_BEGIN namespace com { namespace example { namespace extension_sdk_demo {
#define EXT_SDK_NAMESPACE_END }}}
#define EXT_SDK_NAMESPACE_USING using namespace com::example::extension_sdk_demo;
